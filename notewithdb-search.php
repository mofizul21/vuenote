    ...
    <div id="app">
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-md-7">
                    <form class="form-inline mt-2 mt-md-0 mb-2">
                        <input class="form-control mr-sm-2" type="search" placeholder="Live Search" style="width: 87%" v-model="search" @input="searchWork">
